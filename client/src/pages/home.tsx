...
const Home = () => {
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      {/* Mobile: aakaara branding above content */}
      <div className="flex flex-col md:hidden items-center w-full py-4">
        <span className="font-rigot font-bold text-4xl text-aakaara-dark-brown">aakaara</span>
        <div className="flex space-x-2 text-aakaara-dark-brown text-base mt-2">
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <div
          className="flex-1 px-4 md:px-12 py-8 md:py-20 min-w-0 mt-16 md:mt-0 relative"
          style={{
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-aakaara-text text-[15px] md:text-[18px] leading-[22px] md:leading-[25px] font-normal mb-6 max-w-[600px] animate-slide-up animation-delay-200">
